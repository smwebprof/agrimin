...
class Company_master extends CI_Model{ 
    function __construct() { 
        // Set table name 
        $this->table = 'agrimin_company_master'; 
    } 

    function getRows($params = array()){ 

        $querystring = "SELECT * FROM agrimin_company_master WHERE is_active = 1";
    ...
    function getCompanydata(){ 
        ...
        #$querystring = "SELECT * FROM agrimin_company_master WHERE is_active = 1 order by id desc";
        $querystring = "SELECT acm.*,acnt.name country,ast.name state,act.name city FROM agrimin_company_master acm left join agrimin_countries acnt ON acnt.id=acm.countryid left join agrimin_states ast ON ast.id=acm.stateid left join agrimin_cities act ON act.id=acm.cityid Where acm.is_active = 1";
    ...
    function getCompanydatabyid($params){ 
        ...
        $query_getCompanydatabyid = "SELECT * FROM agrimin_company_master WHERE is_active = 1 and id= '".$params."'";
    ...
    function fetch_branch($comp_id)
    {
      ...
      $querystring = "SELECT * FROM agrimin_branch_master WHERE comp_id = '".$comp_id."' and is_active = 1";
      $queryforpubid = $this->db->query($querystring);
    ...
    function fetch_fin_year($comp_id)
    {
      ...
      $querystring = "SELECT * FROM agrimin_fin_yr WHERE comp_id = '".$comp_id."'";
      $queryforpubid = $this->db->query($querystring);
    ...
    function getCountries($params = array()){ 
        ...
        $querystring = "SELECT * FROM agrimin_countries order by id";
        $queryforpubid = $this->db->query($querystring);
    ...
    function getStates($country_id){ 
        ...
        $querystring = "SELECT * FROM agrimin_states where country_id = '".$country_id."'";
        $queryforpubid = $this->db->query($querystring);
    ...
    function getCities($state_id){ 
        ...
        $querystring = "SELECT * FROM agrimin_cities WHERE state_id = '".$state_id."'";
        $queryforpubid = $this->db->query($querystring);
    ...
    function fetch_countrycode($country_id){ 
        ...
        $querystring = "SELECT phonecode FROM agrimin_countries where id = '".$country_id."'";
        $queryforpubid = $this->db->query($querystring);
        $output = '';
        $result = $queryforpubid->result_array();
        foreach($result as $row)
    ...
    //print_r($result);exit;
    $this->db->insert('agrimin_company_master',$result);
   ...
   public function updateCompanymaster($data){
      ...
      $this->db->limit(1);
      $this->db->update('agrimin_company_master',$result);
   ...
   function fetchCountryById($params){ 
        ...
        $querystring = "SELECT * FROM agrimin_countries where id =".$params;
        $queryforpubid = $this->db->query($querystring);
    ...
    function fetchStateById($params){ 
        ...
        $querystring = "SELECT * FROM agrimin_states where id =".$params;
        $queryforpubid = $this->db->query($querystring);
    ...
    function fetchCityById($params){ 
        ...
        $querystring = "SELECT * FROM agrimin_cities where id =".$params;
        $queryforpubid = $this->db->query($querystring);
