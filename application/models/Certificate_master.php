...
class Certificate_master extends CI_Model{ 
    ...
    function getQCertIdByBranch() { 
        ...
        $querystring = 'SELECT certificate_id FROM agrimin_quality_certificate_master aqcm Where aqcm.user_comp_id = "'.$_SESSION['comp_id'].'" and aqcm.user_branch_id = "'.$_SESSION['branch_id'].'" Order By certificate_id desc limit 1';
