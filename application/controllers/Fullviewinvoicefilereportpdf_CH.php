...
class Fullviewinvoicefilereportpdf_CH extends CI_Controller {
    ...
    public function index()
    {
        ...
        $pdf1 = '<table width="100%" cellpadding="0" border="0">
          <tr>
              ...
              <td width="50%">
                  <table width="100%" border="0" align="left">
                      ...
                      <tr><td>'.$invoice_address.'</td></tr>
                      <tr><td>'.$invoice_data['city'].','.$invoice_data['state'].','.$invoice_data['country'].'</td></tr>';
              if (!empty(@$zipcode)) { $pdf1 .= '<tr><td>Postal Code : '.@$zipcode.'</td></tr>'; }          
              if (!empty(@$email)) { $pdf1 .= '<tr><td>Email : '.@$email.'</td></tr>'; }  
           ...
           $pdf1 .= '<td width="50%">
                  <table width="100%" border="0" align="right">
                      <tr><td><font size="10"><b>Invoice No : '.$invoice_data['invoice_no'].'</b></font></td></tr>
                      <tr><td><font size="10"><b>Invoice Date : '.$invoice_data['invoice_date'].'</b></font></td></tr>
                  </table>   
              </td>';
          $pdf1 .= '</tr>
          </table>';
          ...
          $pdf3 = '';
          if (!empty($invoice_data['file_no'])) { $pdf3 .= '<tr><th width="20%"><b>REF No</b></th><th width="80%">'.$invoice_data['file_no'].'</th></tr>'; }
          ...
          $content .= '<h3 align="center"><u>Invoice</u></h3><br /><br />';  
    ...
    public function index111()
    {
       ...
       #$logo = ASSETS_PATH.'img/agrilogo269x74.jpg';
        ...
        require('tcpdf/tcpdf.php');
          ...
          $content .= '
          <br /><br />  
          <table border="1" cellspacing="0" cellpadding="5">'; //<h3 align="center"><u>Particulars</u></h3><br /><br />  
          #$content .= fetch_data();  
          $content .= $pdf3;
          $content .= '</table>';
