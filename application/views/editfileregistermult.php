<style> 
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					File Register (Edit - Multiple Cargo Group)
					</h3>
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="<?php echo BASE_PATH; ?>Viewfileregistermult">
								File
							</a>
							<i class="fa fa-angle-right"></i>
						</li>
							...
							<div class="tab-pane active" id="tab_0">
								<div class="portlet box green">
									...
									<i class="fa fa-pencil"></i> Add New File
										...
										<a href="<?php echo BASE_PATH; ?>Viewfileregistermult" class="btn red">
	...
	?>
												...
												<h3 class="form-section alert alert-info">Cargo Details &nbsp;&nbsp;&nbsp;<font size="2" color="red">Note : Please check the Cargo entries before File Submissions.</font></h3>
												...
												<div class="row">
													<div class="col-md-12">
														...
														<div class="table-scrollable">
															...
															<tbody>
															<?php $i=1;
															foreach ($this->data['cargo_details'] as $k => $v) { ?>
															<input type="hidden" name="div_cargo_id[]" id="div_cargo_id" value="<?php echo $v['id']; ?>" >	
															<tr class="active">
																<td>
																	<select class="form-control input-small cargomaster" name="cargo_group[]" id="cargo_group_<?php echo $i; ?>">
																	 <?php 	foreach ($this->data['cargogroup'] as $p => $q) { 
																	 	    if ($q['id']==$v['cargo_group_id']) { 
																	 ?>
																	 <option value="<?php echo $q['id']; ?>" selected><?php echo $q['name']; ?></option>
																	 <?php } else { ?>
																...
																<td>
																	 <select class="form-control input-small cargomaster" name="cargo[]" id="cargo_<?php echo $i; ?>">
																	 <?php
																	 	foreach ($this->data['cargo'] as $p => $q) {  
																	 		if ($p==$v['cargo_group_id']) {
																	 			foreach ($q as $x => $y) {
																	 				if ($y['id']==$v['cargo_id']) {
																	 		?>
																	 		<option value="<?php echo $y['id']; ?>" selected><?php echo $y['commodity_name']; ?></option>
																	 	    <?php } else { ?>
																	 	    <option value="<?php echo $y['id']; ?>"><?php echo $y['commodity_name']; ?></option>
																...
																<td>
																	 <select class="form-control input-small packingmaster" name="div_packing[]" id="div_packing_<?php echo $i; ?>">
																...
																<td>
																	 <input type="text" class="form-control input-small" placeholder="" name="div_quantity[]" id="div_quantity_<?php echo $i; ?>" value="<?php echo $v['approx_qty']; ?>" >
																</td>
																<td>
																	 <select class="form-control input-small unitmaster" name="div_unit[]" id="div_unit_<?php echo $i; ?>">
																...
																<td>
																	 <input type="text" class="form-control input-small div_origin" id="div_origin_<?php echo $i; ?>" name="div_origin[]" value="<?php echo $v['origin']; ?>">
																</td>
																<td>
																	 <input type="text" class="form-control input-small div_container_wt" id="div_load_port_<?php echo $i; ?>" name="div_load_port[]" value="<?php echo $v['load_port']; ?>">
																</td>
																<td>
																	 <input type="text" class="form-control input-small div_net_wet" id="div_discharge_port_<?php echo $i; ?>" name="div_discharge_port[]" value="<?php echo $v['discharge_port']; ?>">
																</td>
																<td>
																	 <input type="text" class="form-control input-small div_net_wet" id="div_place_attendance_<?php echo $i; ?>" name="div_place_attendance[]" value="<?php echo $v['attendance_placed']; ?>">
																</td>
																<td>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="col-md-offset-9 col-md-9">
															...
															<a href="<?php echo BASE_PATH; ?>Viewfileregistermult"><button type="button" class="btn default">Cancel</button></a>
														</div>
													</div>
													<div class="col-md-6">
													</div>
