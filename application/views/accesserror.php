			...
			<br>
			<?php if (@$this->data['draft_file_id']) { ?>
			<center><h1>This Invoice already in draft Mode.</h1></center>
			<?php } else { ?>
			<center><h1>You do not have access to create Invoice.Please continue...</h1></center>
			<?php }  ?>
		</div>
	</div>
	<!-- END CONTENT -->
