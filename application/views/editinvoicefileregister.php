												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="inspection_dt" id="inspection_dt" value="<?php echo $invoice_data['inspection_date']; ?>">
															...
															<div class="table-responsive">
															   ...
															   <tr class="active">
																...
																<tr class="active">
																	...
																	<td>
																		 <input type="text" class="form-control" placeholder="" name="load_port" id="load_port" value="<?php echo $invoice_data['load_port']; ?>">
																	</td>
																</tr>
																<tr class="active">
																	<td>
																	...
																	<td>
																		 <input type="text" class="form-control" placeholder="" name="discharge_port" id="discharge_port" value="<?php echo $invoice_data['discharge_port']; ?>">
																	</td>
																</tr>
