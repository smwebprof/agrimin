												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="inspection_dt" id="inspection_dt" value="">
															...
															<div class="table-responsive">
															   ...
															   <tr class="active">
																...
																<tr class="active">
																	...
																	<td>
																		 <input type="text" class="form-control" placeholder="" name="inv_load_port" id="inv_load_port" value="<?php echo $this->data['load_port']; ?>">
																	</td>
																</tr>
																<tr class="active">
																	<td>
																	...
																	<td>
																		 <input type="text" class="form-control" placeholder="" name="inv_discharge_port" id="inv_discharge_port" value="<?php echo $this->data['discharge_port']; ?>">
																	</td>
																</tr>
																<?php /*<tr class="active">
																	<td>
