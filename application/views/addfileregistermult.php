<style> 
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					File Register (New - Multiple Cargo Group)
					</h3>
	...
	?>
												...
												<?php /*
												<div class="row cargo_details_product">
													<div class="col-md-6">
														<div class="form-group">
												...
												<div class="row">
													<div class="col-md-12">
														...
														<div class="table-scrollable">
															...
															<tbody>
															<tr class="active" id=cargo_details_row">
																<td>
																	 <!--<select class="form-control input-large select2me" data-placeholder="Select..." name="cargo_group[]" id="cargo_group">-->
																	 <select class="form-control input-small" name="cargo_group[]" id="cargo_group" required>
																		<option value="">Select</option>
																		<?php
														                $cargo_group = $this->data['cargogroup'];
																	 ...
																	 <span for="cargo_group" class="help-block" style="color:red"></span>
																</td>
																<td>
											...
											<div class="row cargo_details_class">
