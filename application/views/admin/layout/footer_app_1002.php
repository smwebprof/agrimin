...
<script>
      ...
      $('#div_invoice_btn').click(function(){  
          //
          $('#invoice_subtotal_amt').val(parseInt($('#div1_invoice_amt').val())+parseInt($('#div2_invoice_amt').val())+parseInt($('#div3_invoice_amt').val())+parseInt($('#div4_invoice_amt').val())+parseInt($('#div5_invoice_amt').val()));
          //$('#invoice_subtotal_amt').val((parseFloat($('#invoice_subtotal_amt').val()))*parseFloat($('#invoice_ex_rate').val()));

          $('#invoice_subtotal').val(parseInt($('#div1_invoice_amt').val())+parseInt($('#div2_invoice_amt').val())+parseInt($('#div3_invoice_amt').val())+parseInt($('#div4_invoice_amt').val())+parseInt($('#div5_invoice_amt').val()));
          //$('#invoice_subtotal').val((parseFloat($('#invoice_subtotal').val()))*parseFloat($('#invoice_ex_rate').val()));

          $('#invoice_total_full_amt').val(parseInt($('#div1_invoice_amt').val())+parseInt($('#div2_invoice_amt').val())+parseInt($('#div3_invoice_amt').val())+parseInt($('#div4_invoice_amt').val())+parseInt($('#div5_invoice_amt').val()));
      ...
      $('#invoice_ex_rate').change(function(){ 
          ...
          if ($('#invoice_total_vat_percnt').val()) {
              $('#invoice_subtotal_amt').val((parseFloat($('#invoice_subtotal').val()))*parseFloat($('#invoice_ex_rate').val()));
              $('#invoice_total_full_amt').val((parseFloat($('#invoice_subtotal_amt').val()))+(parseFloat($('#invoice_subtotal_amt').val())*parseFloat($('#invoice_total_vat_percnt').val())/100));
              ...
              $('#invoice_subtotal_amt').val((parseFloat($('#invoice_subtotal').val()))*parseFloat($('#invoice_ex_rate').val()));
              $('#invoice_total_full_amt').val((parseFloat($('#invoice_subtotal').val()))*parseFloat($('#invoice_ex_rate').val()));
          }  
      ...
      $('#div1_approx_qty').change(function(){ 
          ...
          //$('#invoice_subtotal_amt').val((parseInt($('#invoice_subtotal').val()))*parseInt($('#invoice_ex_rate').val()));
