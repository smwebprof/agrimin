...
<div class="footer">
   <div class="footer-inner">
       2019 &copy; AgriMin International.
   </div>
...
<script src="<?php echo ASSETS_PATH; ?>plugins/jquery-ui/jquery-ui-1.10.3.custom.min.js" type="text/javascript"></script>
...
<script src="<?php echo ASSETS_PATH; ?>plugins/jqvmap/jqvmap/maps/jquery.vmap.russia.js" type="text/javascript"></script>
...
<script src="<?php echo ASSETS_PATH; ?>plugins/jqvmap/jqvmap/maps/jquery.vmap.germany.js" type="text/javascript"></script>
...
<script src="<?php echo ASSETS_PATH; ?>plugins/flot/jquery.flot.min.js" type="text/javascript"></script>
<script src="<?php echo ASSETS_PATH; ?>plugins/flot/jquery.flot.resize.min.js" type="text/javascript"></script>
<script src="<?php echo ASSETS_PATH; ?>plugins/flot/jquery.flot.categories.min.js" type="text/javascript"></script>
<script src="<?php echo ASSETS_PATH; ?>plugins/jquery.pulsate.min.js" type="text/javascript"></script>
<script src="<?php echo ASSETS_PATH; ?>plugins/bootstrap-daterangepicker/moment.min.js" type="text/javascript"></script>
...
<script src="<?php echo ASSETS_PATH; ?>plugins/fullcalendar/fullcalendar/fullcalendar.min.js" type="text/javascript"></script>
...
<script src="<?php echo ASSETS_PATH; ?>scripts/custom/index.js" type="text/javascript"></script>
<script src="<?php echo ASSETS_PATH; ?>scripts/custom/tasks.js" type="text/javascript"></script>
...
jQuery(document).ready(function() {    
   ...
   Index.initIntro();
   Index.initBranchMaster();
   Index.initCargoMaster();
   Index.initCargoGroupMaster();
   Index.initCompanyMaster();
   Index.initClientMaster();
   Index.initPackingMaster();
