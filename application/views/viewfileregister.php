					...
					<div class="portlet box grey">
						...
						<div class="portlet-body">
						    ...
						    <tr class="odd gradeX">
								...
								<td>
									 <a href="<?php echo BASE_PATH; ?>fullviewfileregister?id=<?php echo base64_encode($file_data['id']); ?>"><?php echo $file_data['file_no']; ?></a>
								</td>
								<td>
								...
								<td>
									...
									<span class="label label-sm label-success">
										 <a href="<?php echo BASE_PATH; ?>editfileregister?id=<?php echo base64_encode($file_data['id']); ?>"  style="color:#fff">Edit</a>
									</span><br/><br/>
									<?php } ?>
									<?php  $file_status = array('Invoiced','Completed','Cancelled'); ?>
									<?php  if (!in_array($file_data['status'], $file_status)) { ?>
