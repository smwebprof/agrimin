								...
								<?php /*<a href="<?php echo BASE_PATH; ?>Operationfileregister?id=<?php echo $_GET['id']; ?>" class="btn default yellow-stripe">
									...
									<div class="portlet-body form">
										...
										<form action="" method="post" class="form-horizontal payinvfileregister-form">
											...
											<input type="hidden" name="invoice_recd_amt" id="invoice_recd_amt" value="<?php echo $invoice_data['invoice_rec_amt']; ?>">
											<input type="hidden" name="invoice_bal_amt" id="invoice_bal_amt" value="<?php echo $invoice_data['invoice_balane_amt']; ?>">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="invoice_no" id="invoice_no" value="<?php echo $invoice_data['invoice_no']; ?>" readonly>
															</div>
														</div>
													</div>
													<!--/span-->
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="cheque_no" id="cheque_no" value="">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																...
																<input type="text" class="form-control" name="cheque_date" id="cheque_date" value="<?php echo date('d-m-Y'); ?>"readonly>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="invoice_amt" id="invoice_amt" value="<?php echo number_format((float)$invoice_data['invoice_amt'], 2, '.', ''); ?>" readonly>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="invoice_basic_amt" id="invoice_basic_amt" value="<?php echo $invoice_data['invoice_basic_amt']; ?>" readonly>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="invoice_rec_amt" id="invoice_rec_amt" value="">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="vat_percent" id="vat_percent" value="<?php echo $invoice_data['invoice_vat_percent']; ?>" readonly>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="vat_amt" id="vat_amt" value="<?php echo number_format((float)$invoice_data['invoice_tax_amt'], 2, '.', ''); ?>" readonly>
												...
												<div class="row">
													<?php /*<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="oth_dedcut" id="oth_dedcut" value="">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="col-md-offset-9 col-md-9">
															...
															<a href="<?php echo BASE_PATH;?>Viewfileinvoicepayment"><button type="button" class="btn default">Cancel</button></a>
														</div>
													</div>
													<div class="col-md-6">
													</div>
