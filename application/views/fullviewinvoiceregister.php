					...
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
						...
						<div class="portlet-title">
							...
							<div class="actions">
								...
								<?php if ($_SESSION['country_code']=='CH')  { ?>
								<a href="<?php echo BASE_PATH; ?>Fullviewinvoicefilereportpdf_CH?id=<?php echo base64_encode($this->data['id']); ?>" class="btn green" target="_blank">
					...
					<!-- Start PORTLET-->
						...
						<div class="portlet-body">
							...
							<tr>
								...
								<td>
									<?php echo $invoice_data['approx_qty']; ?> <?php echo @$this->data['invoice_details'][1]['approx_unit'];?>
								</td>
							</tr>
							<tr>
								<td>
